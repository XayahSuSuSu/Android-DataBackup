...
fun PageMediumBackupProcessing(viewModel: IndexViewModel) {
    ...
    val packageItems by viewModel.mediaItems.collectAsStateWithLifecycle()
    val packageSize by viewModel.mediaSize.collectAsStateWithLifecycle()
    val packageSucceed by viewModel.mediaSucceed.collectAsStateWithLifecycle()
    val packageFailed by viewModel.mediaFailed.collectAsStateWithLifecycle()
