...
fun <T> ListScaffold(
    ...
    mapChipGroup: @Composable RowScope.(targetState: Boolean) -> Unit,
            ...
            AnimatedVisibility(visible = fabVisible, enter = scaleIn(), exit = scaleOut()) {
                ExtendedFab(
                    ...
                    text = StringResourceToken.fromStringArgs(
                        StringResourceToken.fromString("$selectedAPKsCount "),
                        StringResourceToken.fromStringId(R.string.apk),
                    ...
                    LazyColumn(modifier = Modifier.paddingHorizontal(PaddingTokens.Level3), verticalArrangement = Arrangement.spacedBy(PaddingTokens.Level3)) {
                        ...
                        if (targetProcessingState) {
                            item {
                                LabelLargeText(
                                    text = StringResourceToken.fromStringArgs(
                                        StringResourceToken.fromStringId(R.string.apk_only),
                                        StringResourceToken.fromString(" - ${packagesApkOnly.size}"),
                                    ).value,
                                    color = com.xayah.core.ui.material3.tokens.ColorSchemeKeyTokens.Primary.toColor(),
                                    fontWeight = FontWeight.Bold
                                )
                            ...
                            items(items = packagesApkOnly, key = packageItemKey) { item ->
                            ...
                            item {
                                LabelLargeText(
                                    text = StringResourceToken.fromStringArgs(
                                        StringResourceToken.fromStringId(R.string.data_only),
                                        StringResourceToken.fromString(" - ${packagesDataOnly.size}"),
                                    ).value,
                                    color = com.xayah.core.ui.material3.tokens.ColorSchemeKeyTokens.Secondary.toColor(),
                                    fontWeight = FontWeight.Bold
                                )
                            ...
                            items(items = packagesDataOnly, key = packageItemKey) { item ->
                                Row(Modifier.animateItemPlacement()) {
                                    packageItem(item)
                                }
                            }
                            ...
                            item {
                                LabelLargeText(
                                    text = StringResourceToken.fromStringArgs(
                                        StringResourceToken.fromStringId(R.string.both),
                                        StringResourceToken.fromString(" - ${packagesBoth.size}"),
                                    ).value,
                                    color = com.xayah.core.ui.material3.tokens.ColorSchemeKeyTokens.Secondary.toColor(),
                                    fontWeight = FontWeight.Bold
                                )
                            ...
                            items(items = packagesBoth, key = packageItemKey) { item ->
                                Row(Modifier.animateItemPlacement()) {
                                    packageItem(item)
                                }
                            }
