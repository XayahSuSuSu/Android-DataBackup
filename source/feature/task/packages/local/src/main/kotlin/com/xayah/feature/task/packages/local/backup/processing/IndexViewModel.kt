                ...
                if (taskState.value == null) {
                    taskRepository.upsertTask(
                        TaskEntity(
                            ...
                            startTimestamp = 0,
                            endTimestamp = 0,
                            path = taskRepository.getTargetPath(),
                            rawBytes = taskRepository.getRawBytes(),
                            availableBytes = taskRepository.getAvailableBytes(),
                            totalBytes = taskRepository.getTotalBytes(),
                        )
                    )
                }
            }
