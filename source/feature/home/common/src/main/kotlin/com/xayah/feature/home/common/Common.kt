package com.xayah.feature.home.common
...
@ExperimentalMaterial3Api
@Composable
fun ActivityCard(modifier: Modifier = Modifier, label: StringResourceToken, icon: ImageVectorToken, details: List<MapItem>, onClick: () -> Unit) {
    OutlinedCard(
        modifier = modifier,
