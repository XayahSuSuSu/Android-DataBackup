package com.xayah.feature.flavor.premium.page.intro
...
import com.xayah.feature.flavor.premium.GuideRoutes
...
fun PageIntro(navController: NavHostController) {
    ...
    val titles = remember {
        listOf(
            ...
            StringResourceToken.fromStringId(id = R.string.network),
    ...
    val subtitles = remember {
        listOf(
            ...
            StringResourceToken.fromStringId(id = R.string.network_subtitle),
    ...
    val contents = remember {
        listOf(
            ...
            StringResourceToken.fromStringId(id = R.string.network_desc),
