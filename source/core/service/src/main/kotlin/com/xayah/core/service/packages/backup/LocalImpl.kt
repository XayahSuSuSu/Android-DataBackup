...
internal class LocalImpl @Inject constructor() : AbstractService() {
    ...
    @Inject
    override lateinit var packagesBackupUtil: PackagesBackupUtil2
    ...
    override suspend fun backupPackage(p: PackageEntity) {
        ...
        var restoreEntity = packageDao.query(p.packageName, OpType.RESTORE, p.userId, p.preserveId, p.extraInfo.compressionType)
        ...
        restoreEntity = p.copy(
            id = id,
            extraInfo = p.extraInfo.copy(opType = OpType.RESTORE),
